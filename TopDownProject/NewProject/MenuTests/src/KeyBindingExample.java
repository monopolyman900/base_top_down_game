 ...
 *               .  When the window first appears, the text field has focus.
 *                   Any keys typed will be entered as data in the text field;
 *               .  Pressing Enter while the text field has focus will cause
